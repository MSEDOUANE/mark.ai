        ...
        <section className="grid gap-4 lg:grid-cols-[280px_1fr]">
          <aside className="space-y-4 rounded-2xl border border-zinc-800 bg-zinc-900/60 p-5">
            ...
            <div className="rounded-xl border border-white/10 bg-zinc-950 p-4">
              <h3 className="text-sm font-semibold text-zinc-50">Related paths</h3>
              <div className="mt-3 space-y-2 text-sm">
                ...
                <Link href="/dashboard/creatives" className="block rounded-lg border border-white/10 px-3 py-2 text-zinc-300 hover:border-white/20 hover:text-white">
