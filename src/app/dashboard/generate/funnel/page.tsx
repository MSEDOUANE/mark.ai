...
import { FunnelGenerator } from "./funnel-generator";
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-8">
          ...
          <div className="mt-2 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">Funnel Designer</h1>
              <p className="mt-0.5 text-sm text-app-text-muted">
                Turn one product into a staged TOFU → MOFU → BOFU journey, with a Morocco/COD-aware conversion playbook.
              </p>
            </div>
          </div>
        </div>

        <FunnelGenerator brands={brands} />
      </div>
    </main>
  );
}
