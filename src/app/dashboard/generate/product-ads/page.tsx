        ...
        <section className="grid gap-4 lg:grid-cols-[280px_1fr]">
          <aside className="space-y-4 rounded-2xl border border-app-border bg-app-surface/60 p-5">
            ...
            <div className="rounded-xl border border-white/10 bg-app-bg p-4">
              <h3 className="text-sm font-semibold text-app-text">Quick actions</h3>
              <div className="mt-3 space-y-2 text-sm">
                ...
                <Link href="/dashboard/generate/batch" className="block rounded-lg border border-white/10 px-3 py-2 text-app-text hover:border-white/20 hover:text-white">
