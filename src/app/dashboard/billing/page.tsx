      ...
      <div className="mx-auto max-w-4xl">
        ...
        <section className="mt-4 rounded-xl border border-white/10 bg-zinc-900/80 p-4">
          ...
          <p className="mt-2 text-sm text-zinc-300">
            The app manages ad budgets directly in the connected ad accounts. Current active daily budget total: <strong className="text-zinc-50">{money(activeBudgetMinor, currency)}</strong>.
          </p>
        ...
        <section className="mt-4 grid gap-3 sm:grid-cols-2">
          <Link href="/dashboard/settings" className="rounded-xl border border-white/10 bg-zinc-900/80 p-4 hover:border-white/20">
            <div className="text-sm font-semibold text-zinc-50">Billing controls</div>
            <p className="mt-1 text-sm text-zinc-400">Connect ad accounts, change autonomy, and manage execution settings.</p>
          </Link>
          <Link href="/dashboard/approvals" className="rounded-xl border border-white/10 bg-zinc-900/80 p-4 hover:border-white/20">
            <div className="text-sm font-semibold text-zinc-50">Approval gate</div>
            <p className="mt-1 text-sm text-zinc-400">All spend increases and launches stop here before delivery.</p>
          </Link>
        </section>
      </div>
    </main>
