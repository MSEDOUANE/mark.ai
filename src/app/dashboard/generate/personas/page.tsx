...
import { PersonasGenerator } from "./personas-generator";
          ...
          <div className="mt-2 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-0.5 text-sm text-app-text-muted">
                AI-crafted audience personas with ad hooks, messaging angles and platform recommendations.
              </p>
            </div>
          </div>
        </div>

        <PersonasGenerator brands={brands} />
      </div>
    </main>
  );
}
